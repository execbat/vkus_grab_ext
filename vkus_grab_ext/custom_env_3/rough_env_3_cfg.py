...
from vkus_grab_ext.robot.jaka_zu_12 import JAKA_ZU12_GRIPPER_AG_95_160_CFG
...
class G1RoughEnv3Cfg(CustomLocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.scene.robot = JAKA_ZU12_GRIPPER_AG_95_160_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
...
@configclass
class G1RoughEnv3Cfg_PLAY(G1RoughEnv3Cfg):
