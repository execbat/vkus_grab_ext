...
@configclass
class G1RoughEnv2_demo_Cfg(CustomLocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.scene.robot.init_state.pos = (-0.5, 0.6, 0.0)
        self.scene.robot.init_state.rot = ( 0.350, 0.0, 0.0, 0.937)
...
@configclass
class G1RoughEnv2_demo_Cfg_PLAY(G1RoughEnv2_demo_Cfg):
